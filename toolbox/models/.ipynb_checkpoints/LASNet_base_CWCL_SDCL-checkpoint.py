...
class LASNet(nn.Module):
    ...
    def forward(self, rgb, depth,training = True):
        ...
        RGBD_decoder=[x5_decoder_RGBD, x4_decoder_RGBD, x3_decoder_RGBD, x2_decoder_RGBD]#, x1_decoder_RGBD]
        ...
        if training:
            ...
            Depth_decoder = [x5_decoder_Depth, x4_decoder_Depth, x3_decoder_Depth, x2_decoder_Depth]#, x1_decoder_Depth]
            return semantic, semantic2, semantic_Depth, rgb_dict[4], t_dict[4], RGBD_decoder, Depth_decoder, 
