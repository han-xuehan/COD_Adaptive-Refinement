...
for method_name,method_map_root in RGBD_SOD_Models.items():
    ...
    for name, root in test_datasets.items():
        ...
        root = './work_dir/'
        print(name)
        sal_root = root +'sam_h_blip_mamba_img+text_selfdense/CHAMELEON'
        print(sal_root)
        gt_root = './data/CHAMELEON/GT'
        #gt_root = 'data/COD10K/COD10K_TestingDataset/GT'
        print(gt_root)
